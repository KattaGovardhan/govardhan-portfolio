    ...
    <section id="contact" className="relative overflow-hidden py-40">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(closest-side, oklch(0.6 0.2 260 / 55%), transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="relative mx-auto max-w-270 px-6 text-center">
        ...
        <p className="mx-auto mt-8 max-w-xl text-lg text-muted-foreground">
          Tell me about your product, timeline and where you're stuck. I reply
          within a day — usually with pointed questions and a rough plan.
        </p>

        <div className="mt-12 flex flex-wrap items-center justify-center gap-3">
          <MagneticButton
            href="mailto:govardhankatta.dev@gmail.com"
            variant="primary"
          >
